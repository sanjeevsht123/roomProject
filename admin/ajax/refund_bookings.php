<?php
    ...
    if(isset($_POST['get_bookings'])){
      ...
      WHERE (bo.order_id LIKE ? OR bd.phonenum LIKE ? OR bd.user_name LIKE ?)AND
      ...
      while($data=mysqli_fetch_assoc($res))
      {
        ...
        $table_data.="
          <tr>
            ...
            <td>
              <button type='button' onclick='refund_bookings($data[booking_id])' class='btn mt-2 btn-outline-danger btn-sm fw-bold shadow-none'>
              Refund
              </button>
            </td>
          </tr>";
