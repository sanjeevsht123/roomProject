<?php
        ...
        $data.="
         <tr class='align-middle'>
          ...
          <td>
            ...
            <button type='button' onclick=\"room_images($row[id],'$row[name]')\" class='btn btn-info' data-bs-toggle='modal' data-bs-target='#room-images'>
              Image
            </button>

            <button type='button' onclick='remove_room($row[id])' class='btn btn-danger'>
              Remove
            </button>
    ...
    if(isset($_POST['get_room_images'])){
      ...
      while($row=mysqli_fetch_assoc($res)){
        ...
        if($row['thumb']==1){
          $thumb_btn="<i class='bi bi-check0lg text-light bg-success px-2 py-1 rounded fs-5'>";
        }
        echo<<<data
        ...
        <tr class='align-middle'>
         ...
         <td>thumb</td>
         <td>
           <button onclick='rem_images($row[sr_no],$row[room_id])' class='btn btn-Danger btn-sm shadow-none'>
             Delete
           </button>
         </td>
        </tr>
